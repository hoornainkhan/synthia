    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-dark-400 text-sm">Create your account to get started</p>
        </div>

        <div className="glass-card p-10">
          <h2 className="text-xl font-semibold text-dark-100 mb-1">Create Account</h2>
          <p className="text-dark-400 text-sm mb-8">Start generating synthetic datasets in seconds</p>
